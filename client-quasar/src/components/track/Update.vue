<template>
  <div>
    ...
    <TrackForm v-if="item" :values="item" :errors="violations" />
  </div>
</template>
...
export default {
  ...
  computed: {
    ...mapGetters({
      isLoading: 'track/update/isLoading',
      error: 'track/update/error',
      deleteError: 'track/del/error',
      deleteLoading: 'track/del/isLoading',
      deleted: 'track/del/deleted',
      retrieved: 'track/update/retrieved',
      updated: 'track/update/updated',
      violations: 'track/update/violations',
    }),
  },
  ...
  methods: {
    ...mapActions({
      createReset: 'track/create/reset',
      deleteItem: 'track/del/del',
      delReset: 'track/del/reset',
      retrieve: 'track/update/retrieve',
      updateReset: 'track/update/reset',
      update: 'track/update/update',
    }),

    del() {
      if (window.confirm(this.$t('Are you sure you want to delete this track ?'))) {
