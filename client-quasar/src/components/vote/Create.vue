<template>
  <div>
    ...
    <VoteForm ref="createForm" :values="item" :errors="violations" />
  </div>
</template>
...
const { mapGetters, mapActions } = createNamespacedHelpers('vote/create');
...
export default {
  ...
  watch: {
    ...
    created: function (created) {
      ...
      this.$router.push({ name: 'VoteUpdate', params: { id: created['@id'] } });
    },
